...
class JGWillReActAgentChat_Agents implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor(fields?: { sessionId?: string }) {
        this.label = 'JGWill ReAct Agent for Chat Models'
        this.name = 'JGWillReActAgentChat'
        this.version = 4.0
        this.type = 'AgentExecutor'
        this.category = 'Agents'
        this.icon = 'agent.svg'
        this.description = 'Agent that uses the JGWill ReAct logic to decide what action to take, optimized to be used with Chat Models. See my version of ReAct: https://smith.langchain.com/hub/jgwill/react2chat'
    ...
    async run(nodeData: INodeData, input: string, options: ICommonObject): Promise<string | object> {
        ...
        const prompt = await pull<PromptTemplate>('jgwill/react2chat')
...
module.exports = { nodeClass: JGWillReActAgentChat_Agents }
