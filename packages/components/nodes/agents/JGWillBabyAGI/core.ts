...
export class JGWillBabyAGI {
    ...
    static fromLLM(llm: BaseChatModel, vectorstore: VectorStore, maxIterations = 3, topK = 4): JGWillBabyAGI {
        ...
        return new JGWillBabyAGI(taskCreationChain, taskPrioritizationChain, executionChain, vectorstore, maxIterations, topK)
    }
}
